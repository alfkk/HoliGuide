...
function dayChangeGuide()
{
	...
	case "Select Day":
		...
		break;
	case "Day 1":
		document.getElementById("test9").innerHTML="1";
		document.getElementById("test10").innerHTML="Happy Happy Day";
		document.getElementById("test11").innerHTML="Happy Happy Day";
		document.getElementById("test12").innerHTML="Happy Happy Day";
		document.getElementById("test13").innerHTML="Happy Happy Day";
		document.getElementById("test14").innerHTML="Happy Happy Day";
		document.getElementById("test15").innerHTML="Happy Happy Day";
		document.getElementById("test16").innerHTML="Happy Happy Day";
	  break;
	case "Day 2":
		document.getElementById("test9").innerHTML="2";
		document.getElementById("test10").innerHTML="Happy Happy Day";
		document.getElementById("test11").innerHTML="Happy Happy Day";
		document.getElementById("test12").innerHTML="Happy Happy Day";
		document.getElementById("test13").innerHTML="Happy Happy Day";
	  ...
	  break;
	case "Day 3":
		document.getElementById("test9").innerHTML="3";
		document.getElementById("test10").innerHTML="Happy Happy Day";
		document.getElementById("test11").innerHTML="Happy Happy Day";
		document.getElementById("test12").innerHTML="Happy Happy Day";
		document.getElementById("test13").innerHTML="Happy Happy Day";
...
<jsp:body>
	<div class="content">
		<div class="container-fluid">
				...
				<div class="col-xs-9">
					<div class="row">
						...
						<div class="col-xs-3">
							...
							<a href="create_itinerary.jsp">
							<a href="/reviewitinerary"><button type="button" class="btn btn-primary">Submit Proposal</button></a>
							</a>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<P class="displaycenterfornoguides">
						<span style="font-size:30px">No tour guide proposals for this itinerary yet!</span>
					</P>
				</div>
			</div>
		</div>
