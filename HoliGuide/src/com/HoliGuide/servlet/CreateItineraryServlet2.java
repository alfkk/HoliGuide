...
public class CreateItineraryServlet2 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("/app/create_itinerary2.jsp");
		rd.forward(req, resp);
	}
	
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		//System.out.println("from_date   : " + req.getParameter("from_date"));
		//System.out.println("to_date     : " + req.getParameter("to_date"));
		//System.out.println("trav_num    : " + req.getParameter("trav_num"));
		//System.out.println("budget      : " + req.getParameter("budget"));
		//System.out.println("destination : " + req.getParameter("destination"));
		//System.out.println("itinerary   : " + req.getParameter("itinerary"));
		...
		for(int i=1; i<(allUser.size()+5); i++) {
			userListArray.add("create2_user" + i + "@holiguide.com");
		}
			...
			for(int i=0; i<userListArray.size(); i++){
				doAdd = true;
				if(allUser.isEmpty()) {
					user.addUser("create2_user1@holiguide.com",  "", "");
					email = "create2_user1@holiguide.com";
					break;
				}
